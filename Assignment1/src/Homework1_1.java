...
public class Homework1_1 {
	...
	public static void main (String[] args) {
		...
		outPutList(scoreListA, "Scores that are getting A:");
		outPutList(scoreListB, "Scores that are getting B:");
		outPutList(scoreListC, "Scores that are getting C:");
		outPutList(scoreListD, "Scores that are getting D:");
		outPutList(scoreListF, "Scores that are getting F:");
	}
