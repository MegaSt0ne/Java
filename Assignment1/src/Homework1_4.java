...
public class Homework1_4 {
	public static void main(String[] args) {
		...
		//sbuf1.append().append()
		System.out.printf("sbuf1.append(boolean).append(sbuf2): %s \n", 
				sbuf1.append(true).append(sbuf2));
		
		//sbuf1.append()
		System.out.printf("sbuf1.append(myClass): %s \n", sbuf1.append(myClass));
		
		//sbuf1.insert().insert()
		System.out.printf("sbuf1.insert(boolean).insert(sbuf2): %s \n", sbuf1.insert(0, true).insert(0, sbuf2));
